 ...
 *
 */
public class StartTrackingAlarmBeta extends BroadcastReceiver {
	
	private final static String TAG = StartTrackingAlarm.class.getSimpleName();
	private static final String START_TRACKING_ACTION = "edu.rit.se.trafficanalysis.startTrackingBeta";
	...
	public void onReceive(Context context, Intent intent) {
		...
		TrackingService.startTracking(context, true); // it is beta
	}
